      ...
      >
        ...
        >
          <p className="max-w-2xl">
            ...
            efektywność swoich ćwiczeń. Zyskaj dostęp do szczegółowych statystyk
            i rekomendacji, aby osiągnąć swoje cele treningowe szybciej niż
            kiedykolwiek!
          </p>
        ...
        >
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button action={handleOpenModal}>Dodaj swój trening</Button>
          </motion.div>
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
